!function() {
    ...
    function t(e, t, n) {
        ...
        this.g = null != n ? n : null
    }
    function n(e, t) {
        return 0 === e.compare(t) || 1 === e.compare(t)
    }
    function r() {
        var e = a.exec(p[1])
          , n = null
          , r = null
          , i = null;
        return e && (null !== e[1] && e[1] && (n = parseInt(e[1], 10)),
        null !== e[2] && e[2] && (r = parseInt(e[2], 10)),
        null !== e[3] && e[3] && (i = parseInt(e[3], 10))),
        new t(n,r,i)
    }
    function i() {
        var e = s;
        return 3 === e.a || 7 === e.a || 6 === e.a || 9 === e.a || 8 === e.a || 5 === e.a ? "grayscale" : 1 === e.a && n(e.d, new t(6,2)) && 1 === e.e ? "grayscale" : "unknown"
    }
    var o = window
      , a = /^([0-9]+)(?:[\._-]([0-9]+))?(?:[\._-]([0-9]+))?(?:[\._+-]?(.*))?$/;
    t.prototype.compare = function(e) {
        return this.b > e.b || this.b === e.b && this.c > e.c || this.b === e.b && this.c === e.c && this.g > e.g ? 1 : this.b < e.b || this.b === e.b && this.c < e.c || this.b === e.b && this.c === e.c && this.g < e.g ? -1 : 0
    }
    ;
    var s, u = o.navigator.userAgent, c = 0, l = new t, f = 0, d = new t, p = null;
    (p = /(?:iPod|iPad|iPhone).*? OS ([\d_]+)/.exec(u)) ? (f = 3,
    d = r()) : (p = /(?:BB\d{2}|BlackBerry).*?Version\/([^\s]*)/.exec(u)) ? (f = 9,
    d = r()) : (p = /Android ([^;)]+)|Android/.exec(u)) ? (f = 5,
    d = r()) : (p = /Windows Phone(?: OS)? ([^;)]+)/.exec(u)) ? (f = 8,
    d = r()) : (p = /Linux ([^;)]+)|Linux/.exec(u)) ? (f = 4,
    d = r()) : (p = /OS X ([^;)]+)/.exec(u)) ? (f = 2,
    d = r()) : (p = /Windows NT ([^;)]+)/.exec(u)) ? (f = 1,
    d = r()) : (p = /CrOS ([^;)]+)/.exec(u)) && (f = 6,
    d = r()),
    (p = /MSIE ([\d\w\.]+)/.exec(u)) ? (c = 1,
    l = r()) : (p = /Trident.*rv:([\d\w\.]+)/.exec(u)) ? (c = 1,
    l = r()) : (p = /OPR\/([\d.]+)/.exec(u)) ? (c = 4,
    l = r()) : (p = /Opera Mini.*Version\/([\d\.]+)/.exec(u)) ? (c = 4,
    l = r()) : (p = /Opera(?: |.*Version\/|\/)([\d\.]+)/.exec(u)) ? (c = 4,
    l = r()) : (p = /Firefox\/([\d\w\.]+)|Firefox/.exec(u)) ? (c = 3,
    l = r()) : (p = /(?:Chrome|CrMo|CriOS)\/([\d\.]+)/.exec(u)) ? (c = 2,
    l = r()) : (p = /Silk\/([\d\._]+)/.exec(u)) ? (c = 7,
    l = r()) : 5 === f || 9 === f ? c = 6 : (p = /Version\/([\d\.\w]+).*Safari/.exec(u)) && (c = 5,
    l = r()),
    s = new function(e, t, n, r) {
        this.e = e,
        this.f = t,
        this.a = n,
        this.d = r
    ...
    if (1 === s.a) {
        var m;
        if (2 === s.e)
            m = n(s.f, new t(37)) && n(s.d, new t(6,1)) ? "directwrite" : "gdi";
        else {
            var v;
            if (4 === s.e)
                v = n(s.f, new t(24)) && n(s.d, new t(6,1)) ? "directwrite" : "gdi";
            else {
                var y;
                if (-1 === s.d.compare(new t(6,0)))
                    y = "gdi";
                else {
                    var x;
                    if (n(s.d, new t(6,0))) {
        ...
        g = 8 === s.a ? "directwrite" : 2 === s.a || 3 === s.a ? "coretext" : 5 === s.a || 4 === s.a || 6 === s.a || 7 === s.a || 9 === s.a ? "freetype" : "unknown";
    h = g;
    var C = i(), E, S = i();
    E = "unknown" !== S ? S : 2 === s.a || 4 === s.a ? "subpixel" : 1 === s.a ? n(s.d, new t(6,0)) ? "subpixel" : 1 === s.e ? n(s.f, new t(7,0)) ? "subpixel" : "grayscale" : "subpixel" : "unknown";
    var k = o.document.documentElement;
    e("tr-" + h),
    "unknown" === C && "unknown" !== E && (C += "-" + E),
    e("tr-aa-" + C)
}(),
function(e, t) {
    "use strict";
    ...
    function a(e, t, n) {
        return ye(t) ? Te.grep(e, function(e, r) {
    ...
    function p(e) {
        return e.replace(Re, "ms-").replace(Ie, d)
    }
    function h() {
        this.expando = Te.expando + h.uid++
    }
    function g(e) {
    ...
    function v(e, t, n, r) {
        ...
        , u = s(), c = n && n[3] || (Te.cssNumber[t] ? "" : "px"), l = (Te.cssNumber[t] || "px" !== c && +u) && Ue.exec(Te.css(e, t));
        if (l && l[3] !== c) {
            for (u /= 2,
            c = c || l[3],
            l = +u || 1; a--; )
    ...
    function x(e, t) {
        for (var n, r, i = [], o = 0, a = e.length; o < a; o++)
            ...
            i[o] || (r.style.display = "")),
            "" === r.style.display && Xe(r) && (i[o] = y(r))) : "none" !== n && (i[o] = "none",
            Fe.set(r, "display", n)));
        for (o = 0; o < a; o++)
    ...
    function T(e, t, n, i, o) {
        for (var a, s, u, c, l, f, d = t.createDocumentFragment(), p = [], h = 0, g = e.length; h < g; h++)
            if ((a = e[h]) || 0 === a)
                if ("object" === r(a))
                    Te.merge(p, a.nodeType ? [a] : a);
                else if (et.test(a)) {
                    for (s = s || d.appendChild(t.createElement("div")),
                    u = (Je.exec(a) || ["", ""])[1].toLowerCase(),
                    c = Ze[u] || Ze._default,
                    s.innerHTML = c[1] + Te.htmlPrefilter(a) + c[2],
                    f = c[0]; f--; )
                        s = s.lastChild;
                    Te.merge(p, s.childNodes),
        ...
        h = 0; a = p[h++]; )
            if (i && Te.inArray(a, i) > -1)
                o && o.push(a);
            else if (l = Te.contains(a.ownerDocument, a),
            s = b(d.appendChild(a), "script"),
            l && w(s),
            n)
                for (f = 0; a = s[f++]; )
    ...
    function q(e, t, r, i) {
        t = ce.apply([], t);
        var o, a, s, u, c, l, f = 0, d = e.length, p = d - 1, h = t[0], g = ye(h);
        if (g || d > 1 && "string" == typeof h && !ve.checkClone && st.test(h))
            return e.each(function(n) {
                var o = e.eq(n);
                g && (t[0] = h.call(this, n, o.html())),
                q(o, t, r, i)
            });
        if (d && (o = T(t, e[0].ownerDocument, !1, e, i),
        a = o.firstChild,
        1 === o.childNodes.length && (o = a),
        a || i)) {
            for (u = (s = Te.map(b(o, "script"), D)).length; f < d; f++)
                c = o,
                f !== p && (c = Te.clone(c, !0, !0),
                u && Te.merge(s, b(c, "script"))),
                r.call(e[f], c, f);
            if (u)
                ...
                f = 0; f < u; f++)
                    c = s[f],
                    Ke.test(c.type || "") && !Fe.access(c, "globalEval") && Te.contains(l, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? Te._evalUrl && Te._evalUrl(c.src) : n(c.textContent.replace(ut, ""), l, c))
        }
        return e
    }
    function H(e, t, n) {
        for (var r, i = t ? Te.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
            n || 1 !== r.nodeType || Te.cleanData(b(r)),
            r.parentNode && (n && Te.contains(r.ownerDocument, r) && w(b(r, "script")),
            r.parentNode.removeChild(r));
        return e
    }
    function P(e, t, n) {
        var r, i, o, a, s = e.style;
        return (n = n || lt(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || Te.contains(e.ownerDocument, e) || (a = Te.style(e, t)),
        !ve.pixelBoxStyles() && ct.test(a) && ft.test(t) && (r = s.width,
        i = s.minWidth,
        o = s.maxWidth,
    ...
    function R(e) {
        var t = Te.cssProps[e];
        return t || (t = Te.cssProps[e] = M(e) || e),
        t
    }
    function I(e, t, n) {
        var r = Ue.exec(t);
    ...
    function F(e, t, n, r, i, o) {
        ...
        for (; a < 4; a += 2)
            ...
            r ? ("content" === n && (u -= Te.css(e, "padding" + Ve[a], !0, i)),
            "margin" !== n && (u -= Te.css(e, "border" + Ve[a] + "Width", !0, i))) : (u += Te.css(e, "padding" + Ve[a], !0, i),
            "padding" !== n ? u += Te.css(e, "border" + Ve[a] + "Width", !0, i) : s += Te.css(e, "border" + Ve[a] + "Width", !0, i));
    ...
    function W(e, t, n) {
        ...
        ("auto" === i || !parseFloat(i) && "inline" === Te.css(e, "display", !1, r)) && (i = e["offset" + t[0].toUpperCase() + t.slice(1)],
        a = !0),
        (i = parseFloat(i) || 0) + F(e, t, n || (o ? "border" : "content"), a, r, i) + "px"
    }
    function B(e, t, n, r, i) {
        return new B.prototype.init(e,t,n,r,i)
    }
    function _() {
        xt && (!1 === ae.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(_) : e.setTimeout(_, Te.fx.interval),
        Te.fx.tick())
    }
    function z() {
    ...
    function X(e, t, n) {
        var r, i, o, a, s, u, c, l, f = "width"in t || "height"in t, d = this, p = {}, h = e.style, g = e.nodeType && Xe(e), m = Fe.get(e, "fxshow");
        n.queue || (null == (a = Te._queueHooks(e, "fx")).unqueued && (a.unqueued = 0,
        s = a.empty.fire,
        ...
        if ((u = !Te.isEmptyObject(t)) || !Te.isEmptyObject(p)) {
            ...
            null == (c = m && m.display) && (c = Fe.get(e, "display")),
            "none" === (l = Te.css(e, "display")) && (c ? l = c : (x([e], !0),
            c = e.style.display || c,
            l = Te.css(e, "display"),
            x([e]))),
            ("inline" === l || "inline-block" === l && null != c) && "none" === Te.css(e, "float") && (u || (d.done(function() {
                h.display = c
            }),
            null == c && (l = h.display,
            c = "none" === l ? "" : l)),
    ...
    function Y(e, t, n) {
        var r, i, o = 0, a = Y.prefilters.length, s = Te.Deferred().always(function() {
            delete u.elem
        }), u = function() {
            if (i)
                return !1;
            for (var t = yt || z(), n = Math.max(0, c.startTime + c.duration - t), r = 1 - (n / c.duration || 0), o = 0, a = c.tweens.length; o < a; o++)
                c.tweens[o].run(r);
        ...
        for (G(l, c.opts.specialEasing); o < a; o++)
            if (r = Y.prefilters[o].call(c, e, l, c.opts))
                return ye(r.stop) && (Te._queueHooks(c.elem, c.opts.queue).stop = r.stop.bind(r)),
                r;
        return Te.map(l, V, c),
    ...
    Te.extend = Te.fn.extend = function() {
        ...
        s--); s < u; s++)
            if (null != (e = arguments[s]))
                for (t in e)
                    n = a[t],
                    a !== (r = e[t]) && (c && r && (Te.isPlainObject(r) || (i = Array.isArray(r))) ? (i ? (i = !1,
                    o = n && Array.isArray(n) ? n : []) : o = n && Te.isPlainObject(n) ? n : {},
    ...
    Te.extend({
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (i(Object(e)) ? Te.merge(n, "string" == typeof e ? [e] : e) : le.call(n, e)),
            n
        },
    ...
    var Ee = function(e) {
        function t(e, t, n, r) {
            ...
            "string" != typeof e || !e || 1 !== h && 9 !== h && 11 !== h)
                return n;
            if (!r && ((t ? t.ownerDocument || t : B) !== H && q(t),
            t = t || H,
            O)) {
                if (11 !== h && (u = ve.exec(e)))
                    if (i = u[1]) {
        ...
        function y(e, t, n, i, o, a) {
            ...
            o && !o[W] && (o = y(o, a)),
            r(function(r, a, s, u) {
                var c, l, f, d = [], p = [], h = a.length, g = r || m(t || "*", s.nodeType ? [s] : s, []), y = !e || !r && t ? g : v(g, d, e, s, u), x = n ? o || (r ? e : h || i) ? [] : a : y;
                if (n && n(y, x, s, u),
                i)
                    for (c = v(x, p),
                    i(c, [], s, u),
                ...
                if (r) {
                    if (o || e) {
                        ...
                        for (l = x.length; l--; )
                            (f = x[l]) && (c = o ? te(r, f) : d[l]) > -1 && (r[c] = !(a[c] = f))
                    }
                } else
        ...
        function b(e, n) {
            var i = n.length > 0
              ...
              , a = function(r, a, s, u, c) {
                var l, f, d, p = 0, h = "0", g = r && [], m = [], y = j, x = r || o && C.find.TAG("*", c), b = _ += null == y ? 1 : Math.random() || .1, w = x.length;
                for (c && (j = a === H || a || c); h !== w && null != (l = x[h]); h++) {
                    if (o && l) {
                        for (f = 0,
                        a || l.ownerDocument === H || (q(l),
                        s = !O); d = e[f++]; )
                            if (d(l, a || H, s)) {
                                u.push(l);
                                break
        ...
        var w, T, C, E, S, k, N, D, j, A, L, q, H, P, O, M, R, I, F, W = "sizzle" + 1 * new Date, B = e.document, _ = 0, z = 0, U = n(), V = n(), X = n(), G = function(e, t) {
            return e === t && (L = !0),
            0
            ...
            for (var n = 0, r = e.length; n < r; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, ne = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", re = "[\\x20\\t\\r\\n\\f]", ie = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", oe = "\\[" + re + "*(" + ie + ")(?:" + re + "*([*^$|!~]?=)" + re + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + ie + "))|)" + re + "*\\]", ae = ":(" + ie + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + oe + ")*)|.*)\\)|)", $ = new RegExp(re + "+","g"), se = new RegExp("^" + re + "+|((?:^|[^\\\\])(?:\\\\.)*)" + re + "+$","g"), ue = new RegExp("^" + re + "*," + re + "*"), ce = new RegExp("^" + re + "*([>+~]|" + re + ")" + re + "*"), le = new RegExp("=" + re + "*([^\\]'\"]*?)" + re + "*\\]","g"), fe = new RegExp(ae), de = new RegExp("^" + ie + "$"), pe = {
            ID: new RegExp("^#(" + ie + ")"),
            CLASS: new RegExp("^\\.(" + ie + ")"),
            TAG: new RegExp("^(" + ie + "|[*])"),
            ATTR: new RegExp("^" + oe),
        ...
        }, he = /^(?:input|select|textarea|button)$/i, ge = /^h\d$/i, me = /^[^{]+\{\s*\[native \w/, ve = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ye = /[+~]/, xe = new RegExp("\\\\([\\da-f]{1,6}" + re + "?|(" + re + ")|.)","ig"), be = function(e, t, n) {
            var r = "0x" + t - 65536;
        ...
        q = t.setDocument = function(e) {
            ...
            (T.qsa = me.test(H.querySelectorAll)) && (i(function(e) {
                ...
                e.querySelectorAll("[msallowcapture^='']").length && M.push("[*^$]=" + re + "*(?:''|\"\")"),
            ...
            (T.matchesSelector = me.test(I = P.matches || P.webkitMatchesSelector || P.mozMatchesSelector || P.oMatchesSelector || P.msMatchesSelector)) && i(function(e) {
            ...
            F = t || me.test(P.contains) ? function(e, t) {
            ...
            G = t ? function(e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !T.sortDetached && t.compareDocumentPosition(e) === n ? e === H || e.ownerDocument === B && F(B, e) ? -1 : t === H || t.ownerDocument === B && F(B, t) ? 1 : A ? te(A, e) - te(A, t) : 0 : 4 & n ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return L = !0,
                ...
                if (!i || !o)
                    return e === H ? -1 : t === H ? 1 : i ? -1 : o ? 1 : A ? te(A, e) - te(A, t) : 0;
                if (i === o)
                    return a(e, t);
        ...
        t.matchesSelector = function(e, n) {
            if ((e.ownerDocument || e) !== H && q(e),
            n = n.replace(le, "='$1']"),
            T.matchesSelector && O && !X[n + " "] && (!R || !R.test(n)) && (!M || !M.test(n)))
                try {
                    var r = I.call(e, n);
        ...
        t.contains = function(e, t) {
            return (e.ownerDocument || e) !== H && q(e),
            F(e, t)
        }
        ,
        t.attr = function(e, t) {
            ...
            filter: {
                ...
                ATTR: function(e, n, r) {
                    return function(i) {
                        var o = t.attr(i, e);
                        return null == o ? "!=" === n : !n || (o += "",
                        "=" === n ? o === r : "!=" === n ? o !== r : "^=" === n ? r && 0 === o.indexOf(r) : "*=" === n ? r && o.indexOf(r) > -1 : "$=" === n ? r && o.slice(-r.length) === r : "~=" === n ? (" " + o.replace($, " ") + " ").indexOf(r) > -1 : "|=" === n && (o === r || o.slice(0, r.length + 1) === r + "-"))
                    }
                },
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, u) {
                        var c, l, f, d, p, h, g = o !== a ? "nextSibling" : "previousSibling", m = t.parentNode, v = s && t.nodeName.toLowerCase(), y = !u && !s, x = !1;
                        if (m) {
                            if (o) {
                                for (; g; ) {
                                    for (d = t; d = d[g]; )
                            ...
                            a && y) {
                                for (x = (p = (c = (l = (f = (d = m)[W] || (d[W] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === _ && c[1]) && c[2],
                                d = p && m.childNodes[p]; d = ++p && d && d[g] || (x = p = 0) || h.pop(); )
                                    if (1 === d.nodeType && ++x && d === t) {
                                        l[e] = [_, p, x];
                                        break
                                    }
                            } else if (y && (x = p = (c = (l = (f = (d = t)[W] || (d[W] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === _ && c[1]),
                            !1 === x)
                                for (; (d = ++p && d && d[g] || (x = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++x || (y && ((l = (f = d[W] || (d[W] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [_, x]),
                                d !== t)); )
                                    ;
        ...
        D = t.select = function(e, t, n, r) {
            ...
            if (n = n || [],
            1 === l.length) {
                if ((o = l[0] = l[0].slice(0)).length > 2 && "ID" === (a = o[0]).type && 9 === t.nodeType && O && C.relative[o[1].type]) {
            ...
            return (c || N(e, l))(r, t, !O, n, !t || ye.test(e) && f(t.parentNode) || t),
            n
        }
        ,
    ...
    (Te.fn.init = function(e, t, n) {
        ...
        "string" == typeof e) {
            ...
            if (r[1]) {
                ...
                Te.merge(this, Te.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : ae, !0)),
                De.test(r[1]) && Te.isPlainObject(t))
                    for (r in t)
    ...
    Te.each({
        ...
        Te.fn[e] = function(n, r) {
            ...
            this.length > 1 && (qe[e] || Te.uniqueSort(i),
            Le.test(e) && i.reverse()),
            this.pushStack(i)
        }
    });
    ...
    Te.Callbacks = function(e) {
        ...
        var t, n, i, o, a = [], s = [], c = -1, l = function() {
            for (o = o || e.once,
            i = t = !0; s.length; c = -1)
                for (n = s.shift(); ++c < a.length; )
                    !1 === a[c].apply(n[0], n[1]) && e.stopOnFalse && (c = a.length,
                    n = !1);
            e.memory || (n = !1),
            t = !1,
            o && (a = n ? [] : "")
              ...
              , i = {
                ...
                then: function(t, r, i) {
                            ...
                            var s = this
                              ...
                              , f = function() {
                                ...
                                if (!(t < a)) {
                                    ...
                                    ye(f) ? i ? f.call(e, o(a, n, c, i), o(a, n, l, i)) : (a++,
                                    f.call(e, o(a, n, c, i), o(a, n, l, i), o(a, n, c, n.notifyWith))) : (r !== c && (s = void 0,
                                    u = [e]),
                                    (i || n.resolveWith)(s, u))
                                }
                            }
                    ...
                    return Te.Deferred(function(e) {
                        n[0][3].add(o(0, e, ye(i) ? i : c, e.notifyWith)),
    ...
    Te.extend({
        ...
        ready: function(e) {
            ...
            !0 !== e && --Te.readyWait > 0 || Oe.resolveWith(ae, [Te]))
        }
    }),
    Te.ready.then = Oe.then,
    "complete" === ae.readyState || "loading" !== ae.readyState && !ae.documentElement.doScroll ? e.setTimeout(Te.ready) : (ae.addEventListener("DOMContentLoaded", f),
    ...
    Te.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                r = Fe.get(e, t),
                n && (!r || Array.isArray(n) ? r = Fe.access(e, t, Te.makeArray(n)) : r.push(n)),
                r || []
        },
    ...
    Te.event = {
        ...
        add: function(e, t, n, r, i) {
            var o, a, s, u, c, l, f, d, p, h, g, m = Fe.get(e);
            if (m)
                for (n.handler && (n = (o = n).handler,
                i = o.selector),
                i && Te.find.matchesSelector(tt, i),
        ...
        remove: function(e, t, n, r, i) {
            var o, a, s, u, c, l, f, d, p, h, g, m = Fe.hasData(e) && Fe.get(e);
            if (m && (u = m.events)) {
                for (c = (t = (t || "").match(He) || [""]).length; c--; )
                    ...
                    p) {
                        ...
                        a && !d.length && (f.teardown && !1 !== f.teardown.call(e, h, m.handle) || Te.removeEvent(e, p, m.handle),
                        delete u[p])
                    } else
                        for (p in u)
                            Te.event.remove(e, p + t[c], n, r, !0);
                Te.isEmptyObject(u) && Fe.remove(e, "handle events")
            }
        },
        dispatch: function(e) {
            var t = Te.event.fix(e), n, r, i, o, a, s, u = new Array(arguments.length), c = (Fe.get(this, "events") || {})[t.type] || [], l = Te.event.special[t.type] || {};
            for (u[0] = t,
            n = 1; n < arguments.length; n++)
                u[n] = arguments[n];
            if (t.delegateTarget = this,
            !l.preDispatch || !1 !== l.preDispatch.call(this, t)) {
                for (s = Te.event.handlers.call(this, t, c),
                n = 0; (o = s[n++]) && !t.isPropagationStopped(); )
                    for (t.currentTarget = o.elem,
                    r = 0; (a = o.handlers[r++]) && !t.isImmediatePropagationStopped(); )
                        t.rnamespace && !t.rnamespace.test(a.namespace) || (t.handleObj = a,
                        t.data = a.data,
                        void 0 !== (i = ((Te.event.special[a.origType] || {}).handle || a.handler).apply(o.elem, u)) && !1 === (t.result = i) && (t.preventDefault(),
                        t.stopPropagation()));
            ...
            if (u && c.nodeType && !("click" === e.type && e.button >= 1))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        ...
                        a = {},
                        n = 0; n < u; n++)
                            void 0 === a[i = (r = t[n]).selector + " "] && (a[i] = r.needsContext ? Te(i, this).index(c) > -1 : Te.find(i, this, null, [c]).length),
                            a[i] && o.push(r);
                        o.length && s.push({
                            elem: c,
                            handlers: o
    ...
    Te.Event = function(e, t) {
        ...
        this.type = e.type,
        this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? C : E,
    ...
    Te.each({
        ...
        Te.event.special[e] = {
            ...
            handle: function(e) {
                ...
                return i && (i === r || Te.contains(r, i)) || (e.type = o.origType,
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    ...
                    A(e, s);
            return (a = b(s, "script")).length > 0 && w(a, !u && b(e, "script")),
            s
        },
    ...
    Te.fn.extend({
        ...
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++)
                1 === e.nodeType && (Te.cleanData(b(e, !1)),
                e.textContent = "");
            return this
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return Me(this, function(e) {
                ...
                if ("string" == typeof e && !at.test(e) && !Ze[(Je.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n < r; n++)
                            1 === (t = this[n] || {}).nodeType && (Te.cleanData(b(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        replaceWith: function() {
            ...
            return q(this, arguments, function(t) {
                ...
                Te.inArray(this, e) < 0 && (Te.cleanData(b(this)),
    ...
    !function() {
        ...
        var r, i, o, a, s, u = ae.createElement("div"), c = ae.createElement("div");
    ...
    Te.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = p(t), u = pt.test(t), c = e.style;
                if (u || (t = R(s)),
                a = Te.cssHooks[t] || Te.cssHooks[s],
                void 0 === n)
                    return a && "get"in a && void 0 !== (i = a.get(e, !1, r)) ? i : c[t];
                "string" == (o = typeof n) && (i = Ue.exec(n)) && i[1] && (n = v(e, t, i),
                o = "number"),
                null != n && n === n && ("number" === o && (n += i && i[3] || (Te.cssNumber[s] ? "" : "px")),
    ...
    Te.each(["height", "width"], function(e, t) {
        Te.cssHooks[t] = {
            get: function(e, n, r) {
                if (n)
                    return !dt.test(Te.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? W(e, t, r) : Ge(e, ht, function() {
                        return W(e, t, r)
                    })
            },
            set: function(e, n, r) {
                var i, o = lt(e), a = "border-box" === Te.css(e, "boxSizing", !1, o), s = r && F(e, t, r, a, o);
                return a && ve.scrollboxSize() === o.position && (s -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - F(e, t, "border", !1, o) - .5)),
                s && (i = Ue.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n,
                n = Te.css(e, t)),
                I(e, n, s)
            }
        }
    }),
    Te.cssHooks.marginLeft = O(ve.reliableMarginLeft, function(e, t) {
        if (t)
            return (parseFloat(P(e, "marginLeft")) || e.getBoundingClientRect().left - Ge(e, {
                marginLeft: 0
            }, function() {
    ...
    Te.fx.step = {};
    var yt, xt, bt = /^(?:toggle|show|hide)$/, wt = /queueHooks$/;
    Te.Animation = Te.extend(Y, {
        tweeners: {
            "*": [function(e, t) {
                var n = this.createTween(e, t);
                return v(n.elem, e, Ue.exec(t), n),
                n
            }
            ]
        },
    ...
    Te.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each(function() {
                var t, n = Fe.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = Te.timers, a = r ? r.length : 0;
                for (n.finish = !0,
                Te.queue(this, e, []),
    ...
    Te.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? Te.prop(e, t, n) : (1 === o && Te.isXMLDoc(e) || (i = Te.attrHooks[t.toLowerCase()] || (Te.expr.match.bool.test(t) ? Tt : void 0)),
                void 0 !== n ? null === n ? void Te.removeAttr(e, t) : i && "set"in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""),
                n) : i && "get"in i && null !== (r = i.get(e, t)) ? r : null == (r = Te.find.attr(e, t)) ? void 0 : r)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    Te.fn.extend({
        val: function(e) {
            ...
            })) : i ? (t = Te.valHooks[i.type] || Te.valHooks[i.nodeName.toLowerCase()]) && "get"in t && void 0 !== (n = t.get(i, "value")) ? n : "string" == typeof (n = i.value) ? n.replace(kt, "") : null == n ? "" : n : void 0
        }
    }),
    Te.extend({
        valHooks: {
            ...
            select: {
                get: function(e) {
                    var t, n, r, i = e.options, a = e.selectedIndex, s = "select-one" === e.type, u = s ? null : [], c = s ? a + 1 : i.length;
    ...
    Te.extend(Te.event, {
        trigger: function(t, n, r, i) {
            var o, a, s, u, c, l, f, d, p = [r || ae], h = he.call(t, "type") ? t.type : t, g = he.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = d = s = r = r || ae,
            3 !== r.nodeType && 8 !== r.nodeType && !Nt.test(h + Te.event.triggered) && (h.indexOf(".") > -1 && (h = (g = h.split(".")).shift(),
            g.sort()),
            c = h.indexOf(":") < 0 && "on" + h,
            ...
            i || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                if (!i && !f.noBubble && !xe(r)) {
                    ...
                    Nt.test(u + h) || (a = a.parentNode); a; a = a.parentNode)
                        p.push(a),
                        s = a;
                ...
                for (o = 0; (a = p[o++]) && !t.isPropagationStopped(); )
                    ...
                    (l = (Fe.get(a, "events") || {})[t.type] && Fe.get(a, "handle")) && l.apply(a, n),
                    (l = c && a[c]) && l.apply && $e(a) && (t.result = l.apply(a, n),
                    !1 === t.result && t.preventDefault());
                return t.type = h,
                i || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(p.pop(), n) || !$e(r) || c && ye(r[h]) && !xe(r) && ((s = r[c]) && (r[c] = null),
    ...
    Te.parseXML = function(t) {
        ...
        return n && !n.getElementsByTagName("parsererror").length || Te.error("Invalid XML: " + t),
        n
    }
    ;
    var qt = /\[\]$/
    ...
    Te.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !Te(this).is(":disabled") && Ot.test(this.nodeName) && !Pt.test(e) && (this.checked || !Qe.test(e))
            }).map(function(e, t) {
                var n = Te(this).val();
    ...
    Te.extend({
        ...
        ajax: function(t, n) {
            function r(t, n, r, s) {
                ...
                r && (b = re(h, C, r)),
                b = ie(h, b, C, c),
                c ? (h.ifModified && ((w = C.getResponseHeader("Last-Modified")) && (Te.lastModified[o] = w),
            ...
            t = void 0),
            n = n || {};
            var i, o, a, s, u, c, l, f, d, p, h = Te.ajaxSetup({}, n), g = h.context || h, m = h.context && (g.nodeType || g.jquery) ? Te(g) : Te.event, v = Te.Deferred(), y = Te.Callbacks("once memory"), x = h.statusCode || {}, b = {}, w = {}, T = "canceled", C = {
                readyState: 0,
            ...
            if (v.promise(C),
            h.url = ((t || h.url || jt.href) + "").replace(Bt, jt.protocol + "//"),
            ...
            null == h.crossDomain) {
                ...
                try {
                    c.href = h.url,
                    c.href = c.href,
                    h.crossDomain = Vt.protocol + "//" + Vt.host != c.protocol + "//" + c.host
                } catch (e) {
                    h.crossDomain = !0
                }
            }
            if (h.data && h.processData && "string" != typeof h.data && (h.data = Te.param(h.data, h.traditional)),
            te(_t, h, n, C),
            l)
                return C;
            ...
            o = h.url.replace(Rt, ""),
            h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Mt, "+")) : (p = h.url.slice(o.length),
            h.data && (h.processData || "string" == typeof h.data) && (o += (Lt.test(o) ? "&" : "?") + h.data,
            delete h.data),
            !1 === h.cache && (o = o.replace(It, "$1"),
            p = (Lt.test(o) ? "&" : "?") + "_=" + At++ + p),
            h.url = o + p),
            h.ifModified && (Te.lastModified[o] && C.setRequestHeader("If-Modified-Since", Te.lastModified[o]),
    ...
    Te.ajaxPrefilter("json jsonp", function(t, n, r) {
        ...
        if (s || "jsonp" === t.dataTypes[0])
            ...
            s ? t[s] = t[s].replace(Qt, "$1" + i) : !1 !== t.jsonp && (t.url += (Lt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
    ...
    Te.parseHTML = function(e, t, n) {
        ...
        i = De.exec(e),
        o = !n && [],
        i ? [t.createElement(i[1])] : (i = T([e], t, o),
    ...
    Te.offset = {
        setOffset: function(e, t, n) {
            var r, i, o, a, s, u, c, l = Te.css(e, "position"), f = Te(e), d = {};
            "static" === l && (e.style.position = "relative"),
            s = f.offset(),
            o = Te.css(e, "top"),
            u = Te.css(e, "left"),
            (c = ("absolute" === l || "fixed" === l) && (o + u).indexOf("auto") > -1) ? (a = (r = f.position()).top,
        ...
        position: function() {
            if (this[0]) {
                ...
                if ("fixed" === Te.css(r, "position"))
                    ...
                    for (t = this.offset(),
                    n = r.ownerDocument,
                    e = r.offsetParent || n.documentElement; e && (e === n.body || e === n.documentElement) && "static" === Te.css(e, "position"); )
                        e = e.parentNode;
    ...
    Te.each({
        ...
        Te.fn[e] = function(r) {
            return Me(this, function(e, r, i) {
                var o;
                if (xe(e) ? o = e : 9 === e.nodeType && (o = e.defaultView),
                void 0 === i)
                    return o ? o[t] : e[r];
    ...
    Te.each(["top", "left"], function(e, t) {
        Te.cssHooks[t] = O(ve.pixelPosition, function(e, n) {
            if (n)
                return n = P(e, t),
                ct.test(n) ? Te(e).position()[t] + "px" : n
        })
    }),
    Te.each({
        Height: "height",
        ...
        Te.each({
            ...
            Te.fn[r] = function(i, o) {
                ...
                return Me(this, function(t, n, i) {
                    ...
                    Math.max(t.body["scroll" + e], o["scroll" + e], t.body["offset" + e], o["offset" + e], o["client" + e])) : void 0 === i ? Te.css(t, n, s) : Te.style(t, n, i, s)
                }, t, a ? i : void 0, a)
            }
        })
    }),
...
window.Modernizr = function(e, t, n) {
    ...
    function c(e, t, n) {
        ...
        return o(t, "string") || o(t, "undefined") ? s(i, t) : (i = (e + " " + E.join(r + " ") + r).split(" "),
        u(i, t, n))
    }
    function l() {
        d.input = function(n) {
        ...
        d.inputtypes = function(e) {
            for (var r = 0, i, o, a, s = e.length; r < s; r++)
                y.setAttribute("type", o = e[r]),
                i = "text" !== y.type,
                i && (y.value = x,
                y.style.cssText = "position:absolute;visibility:hidden;",
                /^range$/.test(o) && y.style.WebkitAppearance !== n ? (h.appendChild(y),
                a = t.defaultView,
                i = a.getComputedStyle && "textfield" !== a.getComputedStyle(y, null).WebkitAppearance && 0 !== y.offsetHeight,
                h.removeChild(y)) : /^(search|tel)$/.test(o) || (i = /^(url|email)$/.test(o) ? y.checkValidity && !1 === y.checkValidity() : y.value != x)),
                N[e[r]] = !!i;
            return N
        }("search tel url email datetime date month week time datetime-local number range color".split(" "))
    }
    var f = "2.8.3", d = {}, p = !0, h = t.documentElement, g = "modernizr", m = t.createElement(g), v = m.style, y = t.createElement("input"), x = ":)", b = {}.toString, w = " -webkit- -moz- -o- -ms- ".split(" "), T = "Webkit Moz O ms", C = T.split(" "), E = T.toLowerCase().split(" "), S = {
        svg: "http://www.w3.org/2000/svg"
    }, k = {}, N = {}, D = {}, j = [], A = j.slice, L, q = function(e, n, r, i) {
        ...
        if (parseInt(r, 10))
            for (; r--; )
                ...
                s.id = i ? i[r] : g + (r + 1),
                c.appendChild(s);
        return o = ["&#173;", '<style id="s', g, '">', e, "</style>"].join(""),
        c.id = g,
        (l ? c : f).innerHTML += o,
        f.appendChild(c),
        ...
        var r;
        return q("@media " + t + " { #" + g + " { position: absolute; } }", function(t) {
    ...
    M = o(O, "undefined") || o(O.call, "undefined") ? function(e, t) {
        ...
        var r = A.call(arguments, 1)
          , i = function() {
            if (this instanceof i) {
                ...
                var o = new e
                  , a = n.apply(o, r.concat(A.call(arguments)));
    ...
    k.touch = function() {
        var n;
        return "ontouchstart"in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : q(["@media (", w.join("touch-enabled),("), g, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(e) {
            n = 9 === e.offsetTop
        }),
        n
    }
    ...
    k.cssgradients = function() {
        ...
        return r((e + "-webkit- ".split(" ").join("gradient(linear,left top,right bottom,from(#9f9),to(white));" + e) + w.join("linear-gradient(left top,#9f9, white);" + e)).slice(0, -e.length)),
    ...
    k.csstransforms3d = function() {
        var e = !!c("perspective");
        return e && "webkitPerspective"in h.style && q("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function(t, n) {
    ...
    k.generatedcontent = function() {
        var e;
        return q(["#", g, "{font:0/0 a}#", g, ':after{content:"', x, '";visibility:hidden;font:3px/1 a}'].join(""), function(t) {
            e = t.offsetHeight >= 3
        }),
        e
    }
    ...
    function(e, t) {
        ...
        function o(e, n, r) {
            ...
            !o.canHaveChildren || f.test(e) || o.tagUrn ? o : r.frag.appendChild(o)
        }
        function a(e, n) {
            if (e || (e = t),
            v)
            ...
            n = n || i(e);
            for (var o = n.frag.cloneNode(), a = 0, s = r(), u = s.length; a < u; a++)
                o.createElement(s[a]);
            return o
        }
        function s(e, t) {
        ...
        var c = "3.7.0", l = e.html5 || {}, f = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, d = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, p, h = "_html5shiv", g = 0, m = {}, v;
        !function() {
            try {
    ...
    ,
    h.className = h.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + " js " + j.join(" "),
    d
}(this, this.document);
